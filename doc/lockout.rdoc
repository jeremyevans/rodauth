...
account_lockouts_email_last_sent_column :: The email last sent column in the +account_lockouts_table+.  nil by default, so an unlock account email is always sent when requested by default.
