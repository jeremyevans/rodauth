...
sms_already_setup_notice_flash :: The flash notice to show when goign to a page to setup SMS authentication if SMS authentication has already been setup.
...
sms_needs_confirmation_notice_flash :: The flash notice to show on SMS authentication pages when SMS authentication setup needs confirmation.
...
sms_not_setup_notice_flash :: The flash notice to show when on SMS authentication pages when SMS authentication has not yet been setup.
...
before_sms_auth :: Run arbitrary code before SMS authentication code use.
before_sms_confirm :: Run arbitrary code before SMS authentication confirmation.
before_sms_disable :: Run arbitrary code before disabling SMS authentication.
before_sms_request :: Run arbitrary code before SMS authentication code request.
before_sms_setup :: Run arbitrary code before SMS authentication setup.
