...
json_response_success_key :: The JSON result key containing a success message for successful request.  "success" by default, can be set to nil to not set success messages.
