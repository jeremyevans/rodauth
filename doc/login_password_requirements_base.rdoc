...
password_hash_cost :: The algorithm cost to use for the password hash. By default for bcrypt - integer provided by BCrypt::Engine::DEFAULT_COST, for argon2 - { t_cost: 2, m_cost: 16 }.
password_algorithm :: The algorithm for secure hashing password, bcrypt by default. Supported argon2.
