...
The otp feature implements 2 factor authentication via time-based one-time
...
otp_auth_link_text :: The text to use for the link from the two factor auth page.
...
otp_disable_link_text :: The text to use for the disable link from the two factor manage page.
...
otp_setup_link_text :: The text to use for the setup link from the two factor manage page.
