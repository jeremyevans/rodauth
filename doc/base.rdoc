...
prevent_account_reloading? :: Whether to prevent loading an account when one is already loaded (to avoid potential account confusion). By default, this is true for rodauth routes, but not in other cases.
