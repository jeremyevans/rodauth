...
password_expiration_notice_flash :: The flash notice to display when the account's
                                    password has expired and needs to be changed.
password_not_changeable_yet_notice_flash :: The flash notice to display when not
...
password_expiration_session_key :: The key in the session storing whether the password
                                   for the logged in account has expired.
