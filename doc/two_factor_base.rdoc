...
two_factor_already_authenticated_notice_flash :: The flash notice to show if going to a two factor authentication page when already authenticated via 2nd factor
...
two_factor_need_authentication_notice_flash :: The flash notice to show if going to a page that requires two factor authentication when not authenticated.
...
two_factor_not_setup_notice_flash :: The flash notice to show if going to a two factor authentication page when two factor authentication has not been setup.
