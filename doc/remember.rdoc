...
remember_confirm_error_flash :: The flash error to show if password confirmation
                                is unsuccessful.
remember_confirm_notice_flash :: The flash notice to show after password confirmed
                                 successful.
remember_confirm_route :: The route to the confirm password form.
...
before_remember_confirm :: Run arbitrary code before setting that the
                           password has been confirmed.
before_remember_confirm_route :: Run arbitrary code before handling the password
                                 confirmation route.
