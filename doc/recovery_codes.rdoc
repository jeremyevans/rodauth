...
In order to allow users to view authentication recovery codes, the codes are stored
in the database in plain text. This means that an attacker that has access to the
database can view the recovery codes.
