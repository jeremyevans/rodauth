...
require_password_authentication :: If not authenticated via password and the account has a password, redirect to password confirmation page, saving current location to redirect back to after successful password confirmation.
