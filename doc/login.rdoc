...
account_password_hash_table :: The table storing the password hashes, only used
                               if database authentication functions are not used.
account_password_hash_table_column :: The column storing the password hashes in the
