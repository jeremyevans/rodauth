...
remove_reset_password_key :: Remove the reset password key for the current account, run when clearing tokens and if password reset fails after the key is retreived.
