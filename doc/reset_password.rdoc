...
reset_password_email_last_sent_column :: The email last sent column in the +reset_password_table+.  nil by default, so a reset password email is always sent when requested by default.
