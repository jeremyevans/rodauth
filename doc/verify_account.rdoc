...
verify_account_email_last_sent_column :: The email last sent column in the +verify_account_table+.  nil by default, so a verify account email is always sent when requested by default.
