...
Similar to the email_based feature, this uses HMACs for remember
...
The +allow_raw_remember_token_with_deadline_before+ configuration method can
...
Setting +hmac_secret+ will ensure that the OTP secret submitted during
OTP setup by the user was randomly generated by the server.  Without
an HMAC, any secret in the correct format will be accepted.
