...
* OTP Recovery Codes (Single use backup codes)
* OTP SMS Codes (Backup codes via SMS)
...
* {OTP Recovery Codes}[rdoc-ref:doc/otp_recovery_codes.rdoc]
* {OTP SMS Codes}[rdoc-ref:doc/otp_sms_codes.rdoc]
