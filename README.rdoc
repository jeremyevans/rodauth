...
on MySQL this should be run with the +ph+ account.
...
=== When Using PostgreSQL/MySQL without Database Functions

If you want to use Rodauth on PostgreSQL or MySQL without using database
...
PostgreSQL or MySQL, you can set this value to true.
...
support but not require 2 factor authentication:
