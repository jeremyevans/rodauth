...
doesn't use Roda, see this
{example integrating Rodauth into Ginatra, a Sinatra-based git repository viewer}[https://github.com/jeremyevans/ginatra/commit/28108ebec96e8d42596ee55b01c3f7b50c155dd1], 
{example integrating Rodauth into a Grape application}[https://github.com/davydovanton/grape-rodauth], or this
{example integrating Rodauth into a hanami application}[https://github.com/davydovanton/rodauth_hanami].
