...
=== Account Verification/Password Resets/Remember Me/Lockouts

Account verification, password resets, remember, and lockout features
...
There is only a single active account verification/password reset/remember/lockout
