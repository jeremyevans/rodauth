...
module Rodauth
  Feature.define(:verify_account, :VerifyAccount) do
    ...
    auth_value_method :verify_account_resend_explanatory_text, "If you no longer have the email to verify the account, you can request that it be resent to you:"
