...
describe 'Rodauth verify_account feature' do
  ...
  it "should support grace periods when verifying accounts" do
    rodauth do
      enable :login, :logout, :change_password, :create_account, :verify_account
      verify_account_grace_period 86400
    ...
    DB[:accounts].update(:created_at=>Time.now - 100000)
  ...
  it "should verifying accounts while logged in during grace period" do
    rodauth do
      enable :login, :logout, :change_password, :create_account, :verify_account
      verify_account_grace_period 86400
